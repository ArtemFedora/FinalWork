...
class Game():
    ...
    def show_score(self, choice=1):
        ...
        s_font = pygame.font.SysFont('serif', 24)
...
class Snake():
    ...
    def snake_growth_mechanism(
            self, score, food_pos, food_size, screen_width, screen_height):
        # если съели еду
        if (pygame.math.Vector2(self.snake_head_pos).distance_to(pygame.math.Vector2(food_pos)) <self.snake_radius + food_size):
            # если съели еду то задаем новое положение еды случайным
            # образом и увеличивем score на один
            food_pos = [random.randrange(1, screen_width/10)*10,
                        random.randrange(1, screen_height/10)*10]
            food_size = random.randint(1,50)
            self.snake_radius += 1
            score += 1
    ...
    def draw_snake(self, play_surface, surface_color):
        ...
        pygame.draw.circle(
                play_surface, self.snake_color, pygame.math.Vector2(self.snake_head_pos), self.snake_radius)
...
class Food():
    def __init__(self, food_color, screen_width, screen_height):
        ...
        self.food_size = random.randint(1,50)
    ...
    def draw_food(self, play_surface):
        """Отображение еды"""
        pygame.draw.circle(
            play_surface, self.food_color, pygame.math.Vector2(
...
while True:
    ...
    game.score, food.food_pos,food.food_size = snake.snake_growth_mechanism(
        game.score, food.food_pos, food.food_size, game.screen_width, game.screen_height)
